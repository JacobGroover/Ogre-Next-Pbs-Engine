...
namespace Demo
{
    class EngineGraphicsSystem final : public GraphicsSystem
    {
    ...
    public:
        EngineGraphicsSystem( GameState *gameState ) : GraphicsSystem( gameState )
        {
            ...
            //	%APPDATA%/Engine/ on Windows
            //	~/.config/Engine/ on Linux
            //	macCachePath() + "/Engine/" (NSCachesDirectory) on Apple -> Important because
            ...
            //	reset.
            //  Obviously you can replace "Engine" by your app's name.
#if OGRE_PLATFORM == OGRE_PLATFORM_WIN32
            mWriteAccessFolder = +"/";
            TCHAR path[MAX_PATH];
...
#    endif
            ...
            NSURL *libUrl = [NSFileManager.defaultManager URLForDirectory:NSLibraryDirectory
                                                        ...
                                                        appropriateForURL:nil
                                                                   create:YES
                                                                    error:nil];
            // Create "pathToCache/Engine"
            mWriteAccessFolder = Ogre::String( libUrl.absoluteURL.path.UTF8String ) + "/Engine/";
    ...
    const char *MainEntryPoints::getWindowTitle() { return "Engine Engine"; }
}  // namespace Demo
